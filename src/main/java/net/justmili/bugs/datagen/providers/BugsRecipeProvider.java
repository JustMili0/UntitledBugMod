    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider provider, RecipeOutput writer) {
        return new RecipeProvider(provider, writer) {
            ...
            public void buildRecipes() {
                ...
                // Dyed Silks
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.WHITE_DYE, ItemRegistry.WHITE_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.LIGHT_GRAY_DYE, ItemRegistry.LIGHT_GRAY_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.GRAY_DYE, ItemRegistry.GRAY_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.BLACK_DYE, ItemRegistry.BLACK_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.BROWN_DYE, ItemRegistry.BROWN_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.RED_DYE, ItemRegistry.RED_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.ORANGE_DYE, ItemRegistry.ORANGE_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.YELLOW_DYE, ItemRegistry.YELLOW_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.LIME_DYE, ItemRegistry.LIME_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.GREEN_DYE, ItemRegistry.GREEN_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.CYAN_DYE, ItemRegistry.CYAN_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.LIGHT_BLUE_DYE, ItemRegistry.LIGHT_BLUE_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.BLUE_DYE, ItemRegistry.BLUE_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.PURPLE_DYE, ItemRegistry.PURPLE_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.MAGENTA_DYE, ItemRegistry.MAGENTA_SILK);
                gen.dyeItem(TagRegistry.SILK_BLOCK_ITEMS, Items.PINK_DYE, ItemRegistry.PINK_SILK);

                // Dyed Silk Carpets
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.WHITE_DYE, ItemRegistry.WHITE_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.LIGHT_GRAY_DYE, ItemRegistry.LIGHT_GRAY_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.GRAY_DYE, ItemRegistry.GRAY_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.BLACK_DYE, ItemRegistry.BLACK_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.BROWN_DYE, ItemRegistry.BROWN_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.RED_DYE, ItemRegistry.RED_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.ORANGE_DYE, ItemRegistry.ORANGE_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.YELLOW_DYE, ItemRegistry.YELLOW_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.LIME_DYE, ItemRegistry.LIME_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.GREEN_DYE, ItemRegistry.GREEN_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.CYAN_DYE, ItemRegistry.CYAN_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.LIGHT_BLUE_DYE, ItemRegistry.LIGHT_BLUE_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.BLUE_DYE, ItemRegistry.BLUE_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.PURPLE_DYE, ItemRegistry.PURPLE_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.MAGENTA_DYE, ItemRegistry.MAGENTA_SILK_CARPET);
                gen.dyeItem(TagRegistry.SILK_CARPET_ITEMS, Items.PINK_DYE, ItemRegistry.PINK_SILK_CARPET);
